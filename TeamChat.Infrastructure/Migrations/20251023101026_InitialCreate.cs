        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlainToken = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatRoleId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatMemberRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatMemberRoles_ChatMembers_ChatMemberId",
                        column: x => x.ChatMemberId,
                        principalTable: "ChatMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMemberRoles_ChatRoles_ChatRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMemberRoles_ChatMemberId_ChatRoleId",
                table: "ChatMemberRoles",
                columns: new[] { "ChatMemberId", "ChatRoleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChatMemberRoles_ChatRoleId",
                table: "ChatMemberRoles",
                column: "ChatRoleId");
